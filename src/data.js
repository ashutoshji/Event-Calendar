...
export const data = [{
  ...
  'ownerId': [2],
  'startDate': new Date(2019, 4, 1, 9, 0),
  'endDate': new Date(2019, 4, 1, 10, 30),
  'priority': 1
}, {
  'text': 'New Brochures',
  'ownerId': [1],
  'startDate': new Date(2019, 4, 1, 11, 30),
  'endDate': new Date(2019, 4, 1, 14, 15),
  'priority': 2
}, {
  'text': 'Brochure Design Review',
  'ownerId': [4],
  'startDate': new Date(2019, 4, 1, 13, 15),
  'endDate': new Date(2019, 4, 1, 16, 15),
  'priority': 1
}, {
  'text': 'Website Re-Design Plan',
  'ownerId': [3],
  'startDate': new Date(2018, 12, 1, 16, 45),
  'endDate': new Date(2018, 12, 2, 11, 15),
  'priority': 2
}, {
  'text': 'Rollout of New Website and Marketing Brochures',
  'ownerId': [1],
  'startDate': new Date(2018, 12, 2, 8, 15),
  'endDate': new Date(2018, 12, 2, 10, 45),
  'priority': 2
}, {
  'text': 'Update Sales Strategy Documents',
  'ownerId': [2],
  'startDate': new Date(2018, 4, 2, 12, 0),
  'endDate': new Date(2018, 4, 2, 13, 45),
  'priority': 1
}, {
  'text': 'Non-Compete Agreements',
  'ownerId': [4],
  'startDate': new Date(2018, 4, 3, 8, 15),
  'endDate': new Date(2018, 4, 3, 9, 0),
  'priority': 1
}, {
  ...
  'ownerId': [2],
  'startDate': new Date(2019, 4, 19, 12, 45),
  'endDate': new Date(2019, 4, 19, 14, 0),
  'priority': 1
}, {
  'text': 'Training Material Distribution Schedule',
  'ownerId': [2],
  'startDate': new Date(2019, 4, 19, 14, 15),
  'endDate': new Date(2019, 4, 19, 16, 15),
  'priority': 1
}, {
  'text': 'Approval on Converting to New HDMI Specification',
  'ownerId': [4],
  'startDate': new Date(2019, 4, 22, 9, 30),
  'endDate': new Date(2019, 4, 22, 10, 15),
  'priority': 2
}, {
  'text': 'Create New Spike for Automation Server',
  'ownerId': [3],
  'startDate': new Date(2019, 4, 22, 10, 0),
  'endDate': new Date(2019, 4, 22, 12, 30),
  'priority': 2
}, {
  'text': 'Code Review - New Automation Server',
  'ownerId': [1],
  'startDate': new Date(2019, 4, 22, 13, 0),
  'endDate': new Date(2019, 4, 22, 15, 0),
  'priority': 1
}, {
  'text': 'Confirm Availability for Sales Meeting',
  'ownerId': [1],
  'startDate': new Date(2019, 4, 23, 10, 15),
  'endDate': new Date(2019, 4, 23, 15, 15),
  'priority': 2
}, {
  'text': 'Reschedule Sales Team Meeting',
  'ownerId': [2],
  'startDate': new Date(2019, 4, 23, 16, 15),
  'endDate': new Date(2019, 4, 23, 18, 0),
  'priority': 2
}, {
  'text': 'Send 2 Remotes for Giveaways',
  'ownerId': [3],
  'startDate': new Date(2019, 4, 24, 9, 30),
  'endDate': new Date(2019, 4, 24, 11, 45),
  'priority': 1
}, {
  'text': 'Discuss Product Giveaways with Management',
  'ownerId': [1],
  'startDate': new Date(2019, 4, 24, 12, 15),
  'endDate': new Date(2019, 4, 24, 16, 45),
  'priority': 2
}, {
  'text': 'Replace Desktops on the 3rd Floor',
  'ownerId': [2],
  'startDate': new Date(2019, 4, 25, 9, 30),
  'endDate': new Date(2019, 4, 25, 10, 45),
  'priority': 1
}, {
  'text': 'Update Database with New Leads',
  'ownerId': [3],
  'startDate': new Date(2019, 4, 25, 12, 0),
  'endDate': new Date(2019, 4, 25, 14, 15),
  'priority': 2
}, {
  'text': 'Mail New Leads for Follow Up',
  'ownerId': [1],
  'startDate': new Date(2019, 4, 25, 14, 45),
  'endDate': new Date(2019, 4, 25, 15, 30),
  'priority': 2
}, {
  'text': 'Send Territory Sales Breakdown',
  'ownerId': [2],
  'startDate': new Date(2019, 4, 25, 18, 0),
  'endDate': new Date(2019, 4, 25, 20, 0),
  'priority': 1
}, {
  'text': 'Territory Sales Breakdown Report',
  'ownerId': [1],
  'startDate': new Date(2019, 4, 26, 8, 45),
  'endDate': new Date(2019, 4, 26, 9, 45),
  'priority': 1
}, {
  'text': 'Report on the State of Engineering Dept',
  'ownerId': [3],
  'startDate': new Date(2019, 4, 26, 14, 45),
  'endDate': new Date(2019, 4, 26, 15, 30),
  'priority': 2
}, {
  'text': 'Staff Productivity Report',
  'ownerId': [4],
  'startDate': new Date(2019, 4, 26, 16, 15),
  'endDate': new Date(2019, 4, 26, 19, 30),
  'priority': 2
}];
